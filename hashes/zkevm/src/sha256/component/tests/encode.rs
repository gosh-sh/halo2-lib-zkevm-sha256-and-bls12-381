...
fn mock_encode_var_len_bytes_vec() {
    // SHA-256 block boundary: 55 bytes fits in 1 block, 56 bytes needs 2 blocks.
    let inputs = vec![
        (vec![], 1),
        (vec![], 64),
        ((1u8..55).collect_vec(), 64),
        ((1u8..55).collect_vec(), 54),
        ((1u8..55).collect_vec(), 65),
        ((1u8..55).collect_vec(), 128),
        ((1u8..55).collect_vec(), 64 * 3),
        ((0u8..56).collect_vec(), 64),
        ((0u8..128).collect_vec(), 128),
    ];
